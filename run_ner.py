...
class NerProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir):
        ...
        return self._create_examples(
            self._read_txt(os.path.join(data_dir, "train.bio.txt"), sentence_splitter="----"), "train")

    def get_dev_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_txt(os.path.join(data_dir, "dev.bio.txt"), sentence_splitter="----"), "dev")

    def get_test_examples(self, data_dir):
        """See base class."""
        return self._create_examples(
            self._read_txt(os.path.join(data_dir, "test.bio.txt"), sentence_splitter="----"), "test")
...
def main():
    ...
    if args.do_eval and (args.local_rank == -1 or torch.distributed.get_rank() == 0):
        ...
        # report = compute_metrics(y_pred, y_true)
        # print(report)
